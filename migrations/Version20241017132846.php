 ...
 */
final class Version20241017132846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, utilisateur_id INT DEFAULT NULL, nom VARCHAR(90) NOT NULL, prenom VARCHAR(90) NOT NULL, telephone VARCHAR(255) NOT NULL, mail VARCHAR(80) NOT NULL, PRIMARY KEY(id))');
